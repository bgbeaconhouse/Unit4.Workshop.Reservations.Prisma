...
app.post("/api/customers/:id/reservations", async (req, res, next) => {
    try {
        ...
        const reservation = await prisma.reservation.create({data: {customerId, restaurantId, date, partyCount}})
...
app.delete("/api/customers/:customerId/reservations/:id", async (req, res, next) => {
    try {
        ...
        const reservationExists = await prisma.reservation.findFirst({where: {id, customerId},});
